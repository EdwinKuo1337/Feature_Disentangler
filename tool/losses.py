...
- CenterLoss: cent
"""
__all__ = ['CrossEntropyLabelSmooth', 'TripletLoss', 'CenterLoss', 'PspnetLoss']
...
class negativeEntropy(nn.Module):
	...
	def forward(self, x):
		"""
		Args:
			x: prediction matrix (after softmax) with shape (batch_size, num_classes)
		"""
